...
public class TerrainNew extends GameObject {
	
	private final int grid = 64; // patch resolution
	private final float scale = 35000; // scale x/y
	private Mesh mesh;
	...
	public TerrainNew() {
		...
		Pixmap p = new Pixmap(Gdx.files.internal("data/grass.jpeg"));
		...
		texterrain.bind();
		MipMapGenerator.generateMipMap(p, p.getWidth(), p.getHeight());
	}
